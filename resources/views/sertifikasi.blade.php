...
<body>
    ...
    <div class="hero">
        ...
        <div class="hero-content">
            <h1 class="display-4">Sertifikasi Produk</h1>
        </div>
    </div>
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-12 text-center mb-4">
                <h2 class="section-title">Sertifikasi Produk</h2>
                <p>Berikut adalah sertifikasi yang kami miliki untuk produk kami.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="team-card">
                    <img src="https://example.com/sertifikat1.jpg" alt="Sertifikat 1">
                    <div class="position-container">
                        <h5 class="position-title">Sertifikat 1</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="team-card">
                    <img src="https://example.com/sertifikat2.jpg" alt="Sertifikat 2">
                    <div class="position-container">
                        <h5 class="position-title">Sertifikat 2</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="team-card">
                    <img src="https://example.com/sertifikat3.jpg" alt="Sertifikat 3">
                    <div class="position-container">
                        <h5 class="position-title">Sertifikat 3</h5>
                    </div>
                </div>
            </div>
        </div>
